	...
	; Compiler options:
	;
	; -oa2d1.cof -ma2d1.map --summary=default --output=default test1.p1 \
...
;	13 bytes of RAM objects in common bank to zero
	...
	movwf	FSR
	movlw	low(__Lcommon+13)		;load the high address+1 into W
