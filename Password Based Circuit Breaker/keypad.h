...
#define FiveKeypadPort PORTA
#define FiveKeypadDirection TRISA
...
#define MatrixColPort PORTC
#define MatrixColDirection TRISC
...
#define MatrixRowPort PORTA
#define MatrixRowDirection TRISA
